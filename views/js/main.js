/* Following resouces were used to complete the assignment:
Help from https://discussions.udacity.com/t/project-4-how-do-i-optimize-the-background-pizzas-for-loop/36302
http://ryanmorr.com/abstract-away-the-performance-faults-of-queryselectorall/
http://creativejs.com/resources/requestanimationframe/
https://classroom.udacity.com/nanodegrees/nd001/parts/00113454012/modules/273584856175461/lessons/4147498575/concepts/41542085800923#
http://ryanve.com/lab/dimensions/
https://developer.mozilla.org/en-US/docs/Web/API/Window/innerHeight
http://www.html5rocks.com/en/tutorials/speed/animations/
*/

/* polyfill for requestAnimationFrame source https://gist.github.com/paulirish/1579671 */
...
function updatePositions() {
  ...
  var itemsArrLength = items.length;
  var phaseArr = [ ];
 ...
 //debugger;
  for(i=0; i<5; i++) {
    phaseArr.push( Math.sin ( (latestKnownScrollY / viewHeight) + i) );
  }

  //debugger;
  for (i = 0; i < itemsArrLength; i++) {
    var phase = phaseArr[ i % 5 ];
    var leftValue =  items[i].basicLeft + 100 * phase - viewWidth + 'px';
    //debugger;
   items[i].style.transform = 'translateX('+ leftValue+')';
  }
...
/* decoupling the scroll event from update function
http://www.html5rocks.com/en/tutorials/speed/animations/
*/
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  var backgroundPizza = Math.floor(viewportHeight/10);
  console.log(backgroundPizza);
  var getPizzaElement  = document.getElementById("movingPizzas1");
  ...
  for (var i = 0; i < backgroundPizza; i++) {
    ...
    getPizzaElement.appendChild(elem);
  }
  updatePositions();
});
